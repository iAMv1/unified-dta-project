...
try:
    from .protein_encoders import EnhancedCNNProteinEncoder
    from .drug_encoders import EnhancedGINDrugEncoder, MultiScaleGINEncoder
except ImportError:
...
# Import enhanced encoders
try:
    from .drug_encoders import AdvancedGINDrugEncoder, LightweightGINEncoder
except ImportError:
